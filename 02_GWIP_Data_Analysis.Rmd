...
ggplot(df_region, aes(x = decade, y = mean_cov_ii, color = region, group = region, linetype = region)) +
  ...
  scale_color_manual(values = c(
    "Central America" = "grey55",
    "Central Asia"   = "grey70",    
    "East Asia"       = "grey65",   
    "Eastern Europe"   = "grey55", 
    "Middle East"      = "grey45",  
    "North America"    = "grey35",  
    "Northern Africa"   = "grey25", 
    "Oceania"           = "grey33",
    "South America"      = "grey30",
    "South Asia"         = "grey70",
    "South East Asia"    = "grey60",
    "Southern Africa"   = "grey50",
    "Sub-Saharan Africa" = "grey40",
    "Western Europe" = "grey55"
  )) +
...
```{r}
agg_png(here("results", "Fig3_grey.png"), res = 144, height = 750, width = 1200)

ggarrange(plot_cov_grey, plot_gen_grey,
          common.legend = T,
          legend = "bottom") 
