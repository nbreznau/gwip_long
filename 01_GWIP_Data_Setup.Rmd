...
df_trade <- read_csv(here("data", "nunn_slave_trade.csv")) %>%
  mutate(iso3c = ifelse(iso3c == "ZAR", "COD", iso3c)) %>%
  dplyr::select(iso3c, slave_trade_all)
